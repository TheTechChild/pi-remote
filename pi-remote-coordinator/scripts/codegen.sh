...
#
# Output: pi-remote-coordinator/internal/proto/<leg>/<message-type>.go with
# the GENERATED + SPDX headers. Generated files are committed (per § D25).
...
proto_out="${coord_dir}/internal/proto"
